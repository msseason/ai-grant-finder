-- =====================================================
-- AI Grant Finder — Initial Schema
...
-- =====================================================
-- GRANTS (cached from APIs + manual)
-- =====================================================
CREATE TABLE IF NOT EXISTS grants (
  id             UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  source         TEXT NOT NULL DEFAULT 'manual', -- 'grants_gov' | 'sbir' | 'manual'
...
-- =====================================================
-- GRANTOR ANALYSIS (Phase 2 — USASpending.gov cache)
-- =====================================================
CREATE TABLE IF NOT EXISTS grantor_analysis (
  id                UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE POLICY "Grantor analysis is publicly readable"
  ON grantor_analysis FOR SELECT
  USING (true);

-- =====================================================
-- SEED: Sample grants (so the app works immediately)
-- These span diverse sectors — not just tech or Midwest
-- =====================================================
...
VALUES
  ...
  ('manual', 'W.K. Kellogg Foundation Community Engagement and Leadership', 'W.K. Kellogg Foundation', 'Foundation',
  ...
  ('manual', 'Google.org Impact Challenge', 'Google.org', 'Corporate',
   ...
   'Awards funding to nonprofits that are using technology and innovation to tackle some of humanity''s biggest challenges.',
  ...
  ('manual', 'LISC Small Business Lending and Grants', 'Local Initiatives Support Corporation', 'Foundation',
